...
export type TracingConfig = {
  ...
  tracing_config: ArizeConfig | PhoenixConfig | LogfireConfig | LangSmithConfig | LangFuseConfig | DatabricksConfig | MLflowConfig | OpikConfig | WeaveConfig | AliyunConfig | TencentConfig
}
